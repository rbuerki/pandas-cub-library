...
class TestAggregation:
    ...
    def test_mean(self):
        df_result = df1.mean()
        df_answer = pdc.DataFrame(
            {"b": np.array([8.0]), "c": np.array([np.nan])}
        )
        assert_df_equals(df_result, df_answer)
    ...
    def test_var(self):
        df_result = df1.var()
        df_answer = pdc.DataFrame(
            {"b": np.array([b1.var()]), "c": np.array([np.nan])}
        )
        assert_df_equals(df_result, df_answer)
    ...
    def test_std(self):
        df_result = df1.std()
        df_answer = pdc.DataFrame(
            {"b": np.array([b1.std()]), "c": np.array([np.nan])}
        )
        assert_df_equals(df_result, df_answer)
...
class TestReadCSV:
    ...
    def test_head(self):
        data = {
            ...
            "race": np.array(
                ["White", "White", "Black", "Asian", "White"], dtype="O"
            ),
            "gender": np.array(
                ["Male", "Male", "Male", "Male", "Male"], dtype="O"
            ),
